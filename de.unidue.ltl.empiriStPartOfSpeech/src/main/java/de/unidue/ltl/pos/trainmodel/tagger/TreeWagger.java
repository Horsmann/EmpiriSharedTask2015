...
public class TreeWagger extends JCasAnnotator_ImplBase {
	...
	AnalysisEngine treeTagger = null;
	...
	public void initialize(final UimaContext context)
		...
		treeTagger = AnalysisEngineFactory
				.createEngine(TreeTaggerPosTagger.class, TreeTaggerPosTagger.PARAM_LANGUAGE, language,
						TreeTaggerPosTagger.PARAM_VARIANT, variant,
						TreeTaggerPosTagger.PARAM_POS_MAPPING_LOCATION, posMappingLocation);

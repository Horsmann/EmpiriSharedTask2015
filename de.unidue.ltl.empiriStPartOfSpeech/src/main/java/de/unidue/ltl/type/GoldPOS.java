...
/* First created by JCasGen Wed Mar 30 13:41:43 CEST 2016 */
package de.unidue.ltl.type;
...
/** 
 * Updated by JCasGen Wed Mar 30 13:41:43 CEST 2016
 * XML source: /Users/toobee/Documents/Eclipse/EmpiriSharedTask2015/de.unidue.ltl.empiriStPartOfSpeech/src/main/resources/desc/type/POSType.xml
 * @generated */
  ...
  */  
  ...
  public POS getPosTag() {
    if (GoldPOS_Type.featOkTst && ((GoldPOS_Type)jcasType).casFeat_posTag == null)
      jcasType.jcas.throwFeatMissing("posTag", "de.unidue.ltl.type.GoldPOS");
  ...
  public String getCPosTag() {
    if (GoldPOS_Type.featOkTst && ((GoldPOS_Type)jcasType).casFeat_cPosTag == null)
      jcasType.jcas.throwFeatMissing("cPosTag", "de.unidue.ltl.type.GoldPOS");

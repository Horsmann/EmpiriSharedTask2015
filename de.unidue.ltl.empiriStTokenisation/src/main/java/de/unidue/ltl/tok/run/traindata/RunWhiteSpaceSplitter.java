...
public class RunWhiteSpaceSplitter
{
        ...
        throws Exception
    {
        ...
        String OUTPUT_FOLDER = "target/trainData/whitespace/web/";
        ...
        for (String f : files) {
            RunWhiteSpaceSplitter r = new RunWhiteSpaceSplitter();
    ...
    {
        String INPUT_FOLDER = "src/main/resources/trainDataRaw/";
        String OUTPUT_FOLDER = "target/trainData/whitespace/cmc/";
        ...
        throws Exception
    {
        ...
        AnalysisEngineDescription tok = AnalysisEngineFactory
                .createEngineDescription(WhiteSpaceSplitter.class);

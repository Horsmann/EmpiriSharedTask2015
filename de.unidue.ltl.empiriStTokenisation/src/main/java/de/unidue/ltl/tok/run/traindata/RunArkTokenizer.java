...
public class RunArkTokenizer
{
        ...
        throws Exception
    {
        ...
        String OUTPUT_FOLDER = "target/trainData/arktoolsTokenisation/web/";

        String[] pairs = new String[] { INPUT_FOLDER + "web/web_train_001.txt",
        ...
        for (String f : pairs) {
            RunArkTokenizer r = new RunArkTokenizer();
    ...
    {
        String INPUT_FOLDER = "src/main/resources/trainDataRaw/";
        String OUTPUT_FOLDER = "target/trainData/arktoolsTokenisation/cmc/";

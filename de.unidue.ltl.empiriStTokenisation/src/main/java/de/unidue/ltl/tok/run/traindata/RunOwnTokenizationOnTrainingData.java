...
public class RunOwnTokenizationOnTrainingData
{
        ...
        throws Exception
    {
        ...
        String OUTPUT_FOLDER = "target/trainData/own/web/";
        ...
        for (String f : files) {
            RunOwnTokenizationOnTrainingData r = new RunOwnTokenizationOnTrainingData();
    ...
    {
        String INPUT_FOLDER = "src/main/resources/trainDataRaw/";
        String OUTPUT_FOLDER = "target/trainData/own/cmc/";
        ...
        INPUT_FOLDER + "cmc/cmc_train_twitter_1.txt", INPUT_FOLDER + "cmc/cmc_train_twitter_2.txt",
        ...
        throws Exception
    {
        ...
        AnalysisEngineDescription tok = AnalysisEngineFactory.createEngineDescription(
                EmpiriTokeniser.class, EmpiriTokeniser.PARAM_ABBREVIATION_LIST_LOCATION,
        ...
        AnalysisEngineDescription dumper = AnalysisEngineFactory.createEngineDescription(
                ExDumper.class, ExDumper.PARAM_TARGET_FILE, target);
